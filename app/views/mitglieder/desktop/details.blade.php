        ...
        <div class="panel panel-success">
            ...
            <div class="panel-footer">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#" data-toggle="modal" data-target="#modalHundLoeschen_{{$hund->id}}"><span class="glyphicon glyphicon-remove"></span> Hund löschen</a></li>
                    </ul>
                    <div class="modal fade" id="modalHundLoeschen_{{$hund->id}}">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                    <h4 class="modal-title">Hund löschen</h4>
                                </div>
                                <div class="modal-body">
                                    <p>Wollen Sie sich wirklich {{ $hund->name }} löschen? Diese Aktion kann nicht rückgängig gemacht werden.</p>
                                </div>
