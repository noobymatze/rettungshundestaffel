...
<article id="suchgebiet-seite">
    <header id="top-header">
        ...
        <nav id="suchgebiet-nav">
            <ul>
                <a href="{{URL::action('SuchgebieteDesktopController@renderSuchgebiet', array('id' => $suchgebiet->id))}}">
                    <li>Info</li>
                </a>
                <a href="{{URL::action('SuchgebieteDesktopController@renderKarte', array('id' => $suchgebiet->id, 'name' => Str::slug($suchgebiet->name, '_')))}}">
                    <li>Karte</li>
                </a>
                    <li>Training</li>
                <a href="{{ URL::action('SuchgebieteDesktopController@renderPersonen', ['id' => $suchgebiet->id, 'name' => Str::slug($suchgebiet->name, '_')]) }}">
                    <li>Personen</li>
                </a>
                <li>POI</li>
            </ul>
